...
from twitter.TweetExtractorV2 import v_query_api
...
def s_start_scrape(o_scrape_helper):
    o_future = o_executor.submit(v_query_api, o_scrape_helper)
...
s_start_scrape(o_scrape_helper)
s_user = 'Niffirg'
